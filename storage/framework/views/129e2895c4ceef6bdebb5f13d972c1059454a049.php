						...
						<div class="row">
							<div class="noo-main col-md-12">
								...
								<div id="addOrchard">
	                				<div class="col-md-6">
	                					<h2>เพิ่มสวน</h2>
	                					<form method="POST" enctype="multipart/form-data" action="<?php echo e(url('/addorchard')); ?>">
										...
										<input type="hidden" name="idUser" value="<?php echo e(Auth::user()->id); ?>">
	                						<div class="form-row form-row-wide">
												<label for="username">
													...
													<input type="text" class="input-text" name="nameOrchard" id="username" value="<?php echo e(old('nameOrchard')); ?>" style="width: 70%; float: right;" />
												</label>
											</div>
											<div class="form-row form-row-wide">
												<label for="username">
													รายละเอียดสวน :
													<span class="required">*</span>
													<textarea name="description" class="input-text" style="resize: none; width: 70%; float: right;"><?php echo e(old('description')); ?></textarea>
												</label>
											</div>
											<div class="form-row form-row-wide">
												<label for="username">
													พื้นที่สวน :
													<span class="required">*</span>
													<input type="text" class="input-text" name="area" id="username" placeholder="หน่วยเป็นไร่" value="<?php echo e(old('area')); ?>" style="width: 70%; float: right;" />
												</label>
											</div>
											<div class="form-row form-row-wide">
												<label for="username">
											...
											<div class="form-row form-row-wide">
												<label for="username">
													โทรศัพท์ :
													<span class="required">*</span>
													<input type="text" class="input-text" name="phone" id="username" placeholder="กรอกหมายเลขโทรศัพท์" value="<?php echo e(old('phone')); ?>" style="width: 70%; float: right;" />
												</label>
											</div>
											<div class="form-row form-row-wide">
												<label for="username">
													ที่อยู่สวน :
													<span class="required">*</span>
													<textarea name="address" class="input-text" style="resize: none; width: 70%; float: right;"><?php echo e(old('address')); ?></textarea>
												</label>
											</div>
											<div class="form-row form-row-wide">
												<label for="username">
													...
													<select name="idProvince" id="idProvince" class="form-matching" style="width: 70%; float: right;">
														...
														<?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
											 			<?php if($province->idProvince == old('idProvince')): ?>
