						...
						<div class="row">
							<div class="noo-main col-md-9">
								<div class="noo-catalog">
									<p class="commerce-result-count">แสดง <?php echo e($orchards->count()); ?> จากทั้งหมด <?php echo e(App\Orchards::all()->count()); ?></p>
								...
								<?php endif; ?>
									<div class="masonry-item noo-product-column col-md-4 col-sm-6 product">
										...
										<div class="noo-product-inner">
											...
											<div class="noo-product-title"> 
												...
												<?php echo str_limit($strSpecies, $limit = 100); ?>
									...
									<?php if((count($orchards)===$key+1) || $key%3 == 2): ?>
											</div>
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>	
									
								<div class="pagination list-center" style="margin-left:343px">
									<?php echo $orchards->Links();; ?>
