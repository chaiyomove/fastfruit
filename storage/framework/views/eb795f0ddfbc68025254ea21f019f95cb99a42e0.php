...
<html>
	<head>
		...
		<link rel='stylesheet' href='<?php echo e(asset('css/bootstrap.min.css')); ?>' type='text/css' media='all' />
		<link rel='stylesheet' href='<?php echo e(asset('css/settings.css')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('css/owl.carousel.css')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('css/owl.theme.css')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('css/font-awesome.min.css')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('https://fonts.googleapis.com/css?family=Prompt:100,300,400,700,900,300italic,400italic,700italic,900italic')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('css/style.css')); ?>' type='text/css' media='all'/>
		<link rel='stylesheet' href='<?php echo e(asset('css/custom.css')); ?>' type='text/css' media='all'/>
		<link rel="stylesheet" href='<?php echo e(asset('css/magnific-popup.css')); ?>' type='text/css' media='all' />
	...
	<body>
		...
		<div class="site">
			<header class="noo-header header-5 header-static">
							...
							<div class="menu-position">
								<div class="navbar-header pull-left">
									...
									<a href="<?php echo e(url('/')); ?>" class="navbar-brand">
										<img class="noo-logo-img noo-logo-normal" src="<?php echo e(asset('images/fastfruit1.png')); ?>" alt="">
									</a>
								</div>  
									...
									<ul>
										...
										<?php if(Auth::user()): ?>							
											<li>
												...
												<div style="margin-left: -20px;">
													<a href="<?php echo e(url('logout')); ?>">ออกจากระบบ</a>
												</div>
											</li>	
										<?php else: ?>
											<li>
												...
												<div>
													<a href="<?php echo e(url('register')); ?>">สมัครสมาชิก</a>
												</div>
											</li>
										<?php endif; ?>
									</ul>
								...
								<nav class="pull-right noo-main-menu">
									<ul class="nav-collapse navbar-nav">
										<li class="current-menu-item">
											<a href="<?php echo e(url('/')); ?>">หน้าแรก</a>
										</li>
										<li>
											<a href="<?php echo e(url('orchards')); ?>">ชมสวน</a>
										</li>
										<li>
											<a href="<?php echo e(url('products')); ?>">ดูผลผลิต</a>			
										</li>
										<li>
											<a href="<?php echo e(url('matching')); ?>">จับคู่สวน</a>
										</li>
										<li>
											<a href="<?php echo e(url('contactus')); ?>">ติดต่อเรา</a>
										</li>
										<?php if(Auth::user()): ?>
											<li>
												<a href="<?php echo e(url('addorchard')); ?>">เพิ่มสวน</a>
											</li>
										<?php endif; ?>
										<li>
				...
				<div class="search-header5">
					...
					<div class="container">
						<form method="GET" action="<?php echo e(url('search')); ?>" class="form-horizontal">
			...
			<div class="main">
				<div class="noo-simple-product-wrap">
					<ul class="noo-simple-product-slider">
						<li>
							<a href="<?php echo e('orchards/6'); ?>">
								<div class="noo-simple-slider-item" data-bg="<?php echo e(asset('images/slider/br2.jpg')); ?>">
						...
						<li>
							<a href="<?php echo e('orchards/9'); ?>">
								<div class="noo-simple-slider-item" data-bg="<?php echo e(asset('images/slider/br3.jpg')); ?>">
									<div class="n-simple-content">
										<h2>สวนลำไยคุณอิน</h2>
						...
						<li>
							<a href="<?php echo e('orchards/4'); ?>">
								<div class="noo-simple-slider-item" data-bg="<?php echo e(asset('images/slider/br4.jpg')); ?>">
									<div class="n-simple-content">
										<h2>สวนบุญสับปะรด</h2>
						...
						<li>
							<a href="#">
								<div class="noo-simple-slider-item" data-bg="<?php echo e(asset('images/slider/br1.jpg')); ?>">
									<div class="n-simple-content">
							...
							<div class="col-sm-12">
								<div class="noo-product-grid-wrap commerce product-style">
									<div class="noo-sh-title">
										<img width="40" height="39" src="<?php echo e(asset('images/icon_p.png')); ?>" alt=""
										style="margin-bottom: 25px;" />
										<h2>ผลผลิตที่ลงใหม่</h2> 
									</div>
									<?php $__currentLoopData = $latestProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
										<?php if($key%4 == 0): ?>
											...
											<div class="noo-product-inner">
												<div class="noo-product-thumbnail">
													...
													<a href="<?php echo e(url('product', [$product->idProductSprint])); ?>">
														<img style="width: 260px; height: 160px;" src="<?php echo e($product->picture1); ?>" alt="" />
													</a>
												...
												<div class="noo-product-title"> 
													...
													<span class="fa fa-map-marker" style="margin-bottom: 15px; color: rgb(206, 74, 74);">&nbsp;
														<?php echo e($product->orchardPlot->province->provinceName); ?>
										...
										<?php if((count($latestProducts)===$key+1) || $key%4 == 3): ?>
											</div>
										<?php endif; ?>
		...
		<script type='text/javascript' src='<?php echo e(asset('js/jquery-migrate.min.js')); ?>'></script>
		<script type='text/javascript' src='<?php echo e(asset('js/modernizr-2.7.1.min.js')); ?>'></script>
		<script type='text/javascript' src='<?php echo e(asset('js/bootstrap.min.js')); ?>'></script>
		<script type='text/javascript' src='<?php echo e(asset('js/off-cavnass.js')); ?>'></script>
		...
		<script type='text/javascript' src='<?php echo e(asset('js/portfolio.js')); ?>'></script>
		<script type='text/javascript' src='<?php echo e(asset('js/jquery.touchSwipe.min.js')); ?>'></script>
		<script type='text/javascript' src='<?php echo e(asset('js/jquery.carouFredSel-6.2.1.js')); ?>'></script>
		...
		<script type='text/javascript' src='<?php echo e(asset('js/jflickrfeed.min.js')); ?>'></script>
