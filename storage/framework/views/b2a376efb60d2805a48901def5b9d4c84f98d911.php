	...
	jQuery(function ($) {
		$('#follow').on('click', function () {
	        ...
	        if (!$el.hasClass('follow')){
	        	$.get('<?php echo e(url('api/user')); ?>/<?php echo e(Auth::user()->id); ?>/followorchard/<?php echo e($orchard->idOrchard); ?>', function(data){ 
	        		// alert(data);
	        	});	
	        } else {
	        	$.get('<?php echo e(url('api/user')); ?>/<?php echo e(Auth::user()->id); ?>/unfolloworchard/<?php echo e($orchard->idOrchard); ?>', function(data){ 
	        		// alert(data);
	        	});
	        }
	        <?php endif; ?>
										...
										<div class="images">
											<div class="project-slider">
												<div class="owl-carousel sync1">
													<div class="item">
														<img style="width: 400px; height: 265px" src="<?php echo e(asset($orchard->picture1)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 400px; height: 265px" src="<?php echo e(asset($orchard->picture2)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 400px; height: 265px" src="<?php echo e(asset($orchard->picture3)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 400px; height: 265px" src="<?php echo e(asset($orchard->picture4)); ?>" alt="" />
													</div>
												</div>
												<div class="owl-carousel sync2">
													<div class="item">
														<img style="width: 90px; height: 60px" src="<?php echo e(asset($orchard->picture1)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 90px; height: 60px" src="<?php echo e(asset($orchard->picture2)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 90px; height: 60px" src="<?php echo e(asset($orchard->picture3)); ?>" alt="" />
													</div>
													<div class="item">
														<img style="width: 90px; height: 60px" src="<?php echo e(asset($orchard->picture4)); ?>" alt="" />
													</div>
												</div>
											</div>
										</div>
										<div class="summary entry-summary">
											<h1 class="product_title entry-title border_bottom"><?php echo e($orchard->nameOrchard); ?></h1>
											<div class="product_meta">
												<table class="detail">
													<tr>
														<td>ที่อยู่:</td>
														<td><?php echo e($orchard->address); ?></td>
													</tr>
													<tr>
														<td>จังหวัด:</td>
														<td><?php echo e($orchard->province->provinceName); ?></td>
													</tr>
													<tr>
														<td>พื้นที่:</td>
														<td><?php echo e($orchard->area); ?>&nbsp;ไร่</td>
													</tr>
													<tr>

														<?php $__currentLoopData = $orchard->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $admin): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
														<td>ผู้ดูแล:</td>
														<td><a href="<?php echo e(url('profile/'.$admin->id)); ?>"><?php echo e($admin->firstName); ?></a></td>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
													</tr>
													<tr>
														<td>ติดต่อผู้ขาย:</td>
														<td><?php echo e($orchard->phone); ?></td>
													</tr>
												</table>
											</div>
											...
											<?php if(Auth::user()): ?>
												<?php $i = 0?>
												<?php $__currentLoopData = Auth::user()->orchardFollowing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $followedOrchard): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
													<?php if($followedOrchard->idOrchard == $orchard->idOrchard && $i==0): ?>
									            ...
									            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
													...
													<?php endif; ?>
											<?php endif; ?>
											<a href="<?php echo e(url('orchard/' . $orchard->idOrchard . '/edit')); ?>">
									...
									<div class="commerce-tabs">
										...
										<div class="tab-content">
											<div class="tab-pane fade in active" id="tab-1">
												<p><?php echo e($orchard->description); ?></p>
											</div>
													...
													<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
														<li>
															<a href="<?php echo e(url('product', [$product->idProductSprint])); ?>">
																...
																<span class="product-title"><?php echo e($product->orchardPlot->fruitSpecie->specieName); ?></span>
															</a>
											...
											<script>
												jQuery(function($) {
												    $(document).ready(function() {
													    ...
													    <?php if($orchard->lat == NULL || $orchard->lng == NULL): ?>
												    		// Bubble
												        ...
												        <?php else: ?>
												        	var latlng = {lat: <?php echo e($orchard->lat); ?>, lng: <?php echo e($orchard->lng); ?> };
							...
							<div class="noo-sidebar col-md-3">
								<div class="noo-sidebar-wrap">
									...
									<div class="widget commerce widget_products">
										...
										<?php $__currentLoopData = $popOrchards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $popOrchard): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
										<ul class="product_list_widget">
											<li>
												<a href="<?php echo e('orchards/'.$popOrchard->idOrchard); ?>">
													<img style="width: 70px; height: 70px;" src="<?php echo e(asset($popOrchard->picture1)); ?>" alt="" /> 
													<span class="product-title"><?php echo e($popOrchard->nameOrchard); ?></span>
												</a>
												<span class="fa fa-map-marker" style="margin-bottom: 15px; color: rgb(206, 74, 74);">&nbsp;<?php echo e($popOrchard->province->provinceName); ?></span>
											</li>
