							...
							<div class="x_panel tile overflow_hidden" style="height: 220px">
								<div class="x_content">
									...
									<div class="testmonial-img">
										<img src="<?php echo e(asset(Auth::user()->userPicture)); ?>" width="40%" style="float: left; border-radius: 50%;" />
									</div>
									<div style="width: 50%; float: right; text-align: right;">
										
										<p style="font-size: x-large;"><?php echo e(Auth::user()->firstName); ?>&nbsp;<?php echo e(Auth::user()->lastName); ?></p>
										
										<p style="font-size: medium; "><?php echo e(Auth::user()->address); ?></p>
										
										<p style="font-size: medium; "><?php echo e(Auth::user()->province->provinceName); ?></p>

										<div style="margin-top: 15px">
											<a href="<?php echo e(url('addorchard')); ?>" class="btn btn-info btn-sm" style="float: right;">
							          			<h4><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มสวน</h4>
							       		 	</a> 
							       		 	<a href="<?php echo e(url('user/' . Auth::user()->id . '/edit')); ?>" class="btn btn-info btn-sm" style="float: right;">
                    ...
                    <div class="tab-pane" id="orchard">
			            ...
			            <div class="x_content">
			                <div class="row">
				                ...
				                <?php $__currentLoopData = $orchards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orchardTmp): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
