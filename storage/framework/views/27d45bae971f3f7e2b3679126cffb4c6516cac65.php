						...
						<div class="row">
							<div class="noo-main col-md-12">
								...
								<div id="customer_login">
									<div class="col-md-6">
										<h2>สมัครสมาชิก</h2>
										<form class="register" method="POST" action="<?php echo e(url('/register')); ?>">
											...
											<div class="form-row form-row-wide">
												...
												<input type="text" class="input-text" name="firstName" id="reg_fname" value="<?php echo e(old('firstName')); ?>" />
											</div>
											<div class="form-row form-row-wide">
												<label for="reg_lname">
													นามสกุล
												...
												<input type="test" class="input-text" name="lastName" id="reg_lname" value="<?php echo e(old('lastName')); ?>" />
											</div>
											<div class="form-row form-row-wide">
												<label for="reg_email">
													อีเมล
												...
												<input type="email" class="input-text" name="email" id="reg_email" value="<?php echo e(old('email')); ?>" />
											</div>
											<div class="form-row form-row-wide">
